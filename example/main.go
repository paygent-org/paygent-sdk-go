...
func main() {
	...
	client := paygent.NewClientWithURL("pk_e0ea0d11bb7f0d174caf578d665454acff97bdb1f85c235af547ccd9a733ef35", "http://localhost:8080")
	...
	usageData1 := paygent.UsageData{
		ServiceProvider:  paygent.GoogleDeepMind,
		Model:            paygent.Gemini25Flash,
		PromptTokens:     756,
	...
	usageData3 := paygent.UsageData{
		ServiceProvider:  paygent.Custom,
		Model:            "custom-model",
		PromptTokens:     200,
	...
	claudeUsage := paygent.UsageDataWithStrings{
		ServiceProvider: paygent.Anthropic,
		Model:           paygent.Sonnet45,
	...
	log.Println("\n=== AWS Nova Example ===")
	novaUsage := paygent.UsageDataWithStrings{
		ServiceProvider: paygent.AWS,
		Model:           paygent.AmazonNovaLite,
	...
	clientWithInvalidKey := paygent.NewClient("invalid-api-key")
